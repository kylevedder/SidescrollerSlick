...
public class ObjectEnemy extends ObjectBoilerplate
{
    ...
    void render(int shiftRight)
    {
        ...
        {
            this.animLeft.draw(rect.getX() - shiftRight, MainApp.SCREEN_HEIGHT - rect.getY(), rect.getWidth(), rect.getHeight());
        }
        else if (direction == DirectionEnum.RIGHT)
        {
            this.animRight.draw(rect.getX() - shiftRight, MainApp.SCREEN_HEIGHT - rect.getY(), rect.getWidth(), rect.getHeight());
        }  
    }
